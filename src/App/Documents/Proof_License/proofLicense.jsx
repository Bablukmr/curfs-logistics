  ...
  return (
    <div className='mt-[55px] w-full'>
        ...
        <div className="w-full">
              ...
              <div className="border-[#A2A2A7] mt-2 rounded-md border border-solid flex items-center pr-2">
                <select
                  placeholder="10-3-23"
                  className="text-sm h-10 bg-white border-none w-full outline-none px-2 rounded-md"
                >
