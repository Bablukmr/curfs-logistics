    ...
    <div className="mt-[55px] mb-8 w-full">
      <div className="w-[90%] ml-[5%] md:ml-[35%] md:w-[30%]">
        ...
        <div className="flex flex-col gap-3 mt-6">
          <Link className="flex items-center justify-center bg-[#2B3087] h-[50px] w-full text-white font-semibold text-sm rounded-md">
            Beleidsverklaring
          </Link>
          <Link className="flex items-center justify-center bg-[#2B3087] h-[50px] w-full text-white font-semibold text-sm rounded-md">
          ...
          <Link
            to="example-chapter"
            className="flex items-center justify-center bg-[#2B3087] h-[50px] w-full text-white font-semibold text-sm rounded-md"
          >
            Example chapter
          </Link>
          <Link className="flex items-center justify-center bg-[#2B3087] h-[50px] w-full text-white font-semibold text-sm rounded-md">
